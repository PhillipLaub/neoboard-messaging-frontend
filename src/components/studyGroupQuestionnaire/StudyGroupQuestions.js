        ...
        <div className='study-group-questionnaire-container'>
            {error && (
                <div className='questionnaire-alert required'>
                    Please check to see if you have filled out all required
                    fields.
                </div>
            )}
            ...
            {commuter && (
                <Fragment>
                    ...
                    <DropdownInputBox
                        ...
                        func={handleInputChange}
                        boxStyleModifiers={
                            'commuter-box questionnaire-left-border'
                        }
                        required={true}
                    />
            ...
            <RadioScaleBox
                question={
                    'Studying with someone who understands the material well'
                }
            ...
            <RadioScaleBox
                question={
                    'Studying with someone whom I have common ground with'
                }
